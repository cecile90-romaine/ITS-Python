...
from Lezione_6.esercizi_classi.esercizio_9_11_users import User
from Lezione_6.esercizi_classi.esercizio_9_11_users import Privileges
from Lezione_6.esercizi_classi.esercizio_9_11_users import Admin

user1:User = User("Rosa", "Roasali?", "rosaline@gmail.com")
privileges1:Privileges = Privileges(["coppiare", "salvare", "condividere"])
